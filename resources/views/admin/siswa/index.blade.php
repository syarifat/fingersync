                                ...
                                <tr class="group hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="py-5 text-right pr-4">
                                        <div class="flex justify-end gap-3">
                                            ...
                                            <form action="{{ route('admin.siswa.destroy', $s->id) }}" method="POST" onsubmit="confirmDelete(event, 'Menghapus siswa ini juga akan ikut menghapus riwayat keanggotaan kelas (rombel) dan seluruh data presensinya. Lanjutkan?')">
                                                @csrf @method('DELETE')
