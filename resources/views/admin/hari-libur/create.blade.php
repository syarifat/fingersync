<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-800 leading-tight italic">Tambah Hari Libur</h2>
    </x-slot>
            ...
            <form action="{{ route('admin.hari-libur.store') }}" method="POST">
                ...
                <div class="bg-white shadow-2xl rounded-[2rem] overflow-hidden border border-gray-100 p-10">
                    ...
                    <div class="mb-8 border-b border-gray-100 pb-4">
                        <h3 class="text-lg font-black text-orange-600 uppercase tracking-wide">Hari Libur Manual</h3>
                        <p class="text-sm text-gray-500">Mendaftarkan hari libur khusus sekolah atau kegiatan khusus.</p>
                    </div>

                    <div class="space-y-6">
                        <div>
                            <x-input-label for="nama" value="Nama Hari Libur / Acara" class="font-bold text-gray-700" />
                            <x-text-input id="nama" name="nama" type="text" class="mt-2 block w-full focus:ring-orange-500 border-gray-200 rounded-xl" placeholder="Contoh: Libur Kenaikan Kelas, Class Meeting" required autofocus />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="tanggal_mulai" name="tanggal_mulai" type="date" class="mt-2 block w-full focus:ring-orange-500 border-gray-200 rounded-xl" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_selesai" name="tanggal_selesai" type="date" class="mt-2 block w-full focus:ring-orange-500 border-gray-200 rounded-xl" required />
                        ...
                        <div>
                            ...
                            <select name="jenis" id="jenis" class="w-full border-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-xl shadow-sm mt-2" required>
                                <option value="sekolah" selected>Libur Sekolah / Agenda Khusus</option>
                                <option value="nasional">Libur Nasional (PHBN/PHBI)</option>
                            </select>
                        ...
                        <div>
                            ...
                            <textarea id="keterangan" name="keterangan" rows="3" class="w-full border-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-xl shadow-sm mt-2" placeholder="Tulis deskripsi atau alasan libur..."></textarea>
