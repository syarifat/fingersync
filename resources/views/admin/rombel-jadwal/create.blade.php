                ...
                <div class="bg-white shadow-2xl rounded-[2rem] overflow-hidden border border-gray-100 p-10">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="hari" class="w-full border-gray-200 rounded-xl mt-2 focus:ring-orange-500 @error('hari') border-red-500 @enderror" required>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input type="time" name="jam_mulai" class="mt-2 block w-full border-gray-200 rounded-xl @error('jam_mulai') border-red-500 @enderror" value="{{ old('jam_mulai') }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input type="time" name="jam_selesai" class="mt-2 block w-full border-gray-200 rounded-xl @error('jam_selesai') border-red-500 @enderror" value="{{ old('jam_selesai') }}" required />
                                @error('jam_selesai')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <select name="id_ruangan" class="w-full border-gray-200 rounded-xl mt-2 focus:ring-orange-500 @error('id_ruangan') border-red-500 text-red-900 @enderror" required>
