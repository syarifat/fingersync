<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-800 leading-tight italic">
            {{ __('Tambah Kegiatan Sekolah Baru') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-[2rem] border border-gray-100 overflow-hidden">
                <div class="p-8">
                    <div class="mb-8">
                        <h3 class="text-xl font-bold text-orange-600 uppercase tracking-tighter">Form Kegiatan Baru</h3>
                        <p class="text-sm text-gray-500">Masukkan detail kegiatan sekolah serentak untuk membypass KBM reguler pada hari pelaksanaan.</p>
                    </div>
                    ...
                    <form action="{{ route('admin.kegiatan-sekolah.store') }}" method="POST" class="space-y-6">
                        @csrf
                        
                        <div>
                            <label for="nama_kegiatan" class="block text-sm font-bold text-gray-700 uppercase tracking-wider mb-2">Nama Kegiatan</label>
                            <input type="text" name="nama_kegiatan" id="nama_kegiatan" value="{{ old('nama_kegiatan') }}" required class="w-full border-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-xl shadow-sm text-sm py-2.5 px-4">
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="tipe" id="tipe" required class="w-full border-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-xl shadow-sm text-sm py-2.5 px-4">
                                    <option value="serentak" {{ old('tipe') == 'serentak' ? 'selected' : '' }}>Serentak (Bypass KBM Reguler)</option>
                                    <option value="non-serentak" {{ old('tipe') == 'non-serentak' ? 'selected' : '' }}>Non-Serentak (KBM Reguler Tetap Jalan)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-100 pt-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="time" name="jam_mulai_datang" id="jam_mulai_datang" value="{{ old('jam_mulai_datang', '06:30') }}" required class="w-full border-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-xl shadow-sm text-sm py-2.5 px-4 font-mono">
                                </div>
                                <div>
                                    ...
                                    <input type="time" name="jam_selesai_datang" id="jam_selesai_datang" value="{{ old('jam_selesai_datang', '09:00') }}" required class="w-full border-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-xl shadow-sm text-sm py-2.5 px-4 font-mono">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-100 pt-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="time" name="jam_mulai_pulang" id="jam_mulai_pulang" value="{{ old('jam_mulai_pulang', '12:00') }}" required class="w-full border-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-xl shadow-sm text-sm py-2.5 px-4 font-mono">
                                </div>
                                <div>
                                    ...
                                    <input type="time" name="jam_selesai_pulang" id="jam_selesai_pulang" value="{{ old('jam_selesai_pulang', '16:00') }}" required class="w-full border-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-xl shadow-sm text-sm py-2.5 px-4 font-mono">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="keterangan" id="keterangan" rows="3" class="w-full border-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-xl shadow-sm text-sm py-2.5 px-4">{{ old('keterangan') }}</textarea>
                        </div>
