            ...
            <div class="bg-white shadow-sm rounded-[2rem] border border-gray-100 overflow-hidden">
                <div class="p-8">
                    <div class="mb-8">
                        ...
                        <p class="text-sm text-gray-500">Pilih jadwal KBM reguler guru yang terganggu dan tentukan statusnya (Izin/Absen/Diganti).</p>
                    </div>
                        ...
                        <div>
                            ...
                            <select name="id_rombel_jadwal_pelajaran" id="id_rombel_jadwal_pelajaran" required class="w-full border-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-xl shadow-sm text-sm py-2.5 px-4">
                                ...
                                @foreach($jadwals as $jadwal)
                                    <option value="{{ $jadwal->id }}" {{ old('id_rombel_jadwal_pelajaran') == $jadwal->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="status" id="status" required class="w-full border-gray-200 focus:border-orange-500 focus:ring-orange-500 rounded-xl shadow-sm text-sm py-2.5 px-4" onchange="toggleGuruPengganti()">
                                    <option value="izin" {{ old('status') == 'izin' ? 'selected' : '' }}>Izin (KBM Mandiri)</option>
                                    <option value="absen" {{ old('status') == 'absen' ? 'selected' : '' }}>Absen/Mangkir (KBM Mandiri)</option>
                                    <option value="diganti" {{ old('status') == 'diganti' ? 'selected' : '' }}>Digantikan (Terdapat Guru Pengganti)</option>
                                </select>
                            </div>
                        </div>
