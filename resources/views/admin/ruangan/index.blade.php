                ...
                <div class="p-8">
                    ...
                    <div class="mb-6 bg-gray-50 p-5 rounded-2xl border border-gray-100">
                        <form method="GET" action="{{ route('admin.ruangan.index') }}" class="flex flex-col md:flex-row gap-4">
                            ...
                            <div class="flex-1">
                                <label for="search" class="block text-xs font-bold text-gray-500 uppercase mb-1">Cari Ruangan</label>
                                <div class="relative">
                            ...
                            <div class="flex items-end gap-2">
                                ...
                                @if(request('search'))
                                <a href="{{ route('admin.ruangan.index') }}" class="px-4 py-2.5 bg-white border border-gray-300 text-gray-700 text-sm font-bold rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center" title="Reset">
                                ...
                                <tr class="group hover:bg-orange-50/40 transition-colors duration-200">
                                    ...
                                    <td class="py-5 px-4 text-right">
                                        <div class="flex justify-end gap-3">
                                            <a href="{{ route('admin.ruangan.edit', $r->id) }}" class="p-2 bg-orange-100 text-orange-600 rounded-lg hover:bg-orange-600 hover:text-white transition-all shadow-sm" title="Edit">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                </svg>
                                            </a>
                                            <form action="{{ route('admin.ruangan.destroy', $r->id) }}" method="POST" onsubmit="confirmDelete(event, 'Menghapus ruangan ini juga akan ikut menghapus jadwal pelajaran yang menggunakan ruangan ini. Lanjutkan?')">
                                                @csrf @method('DELETE')
