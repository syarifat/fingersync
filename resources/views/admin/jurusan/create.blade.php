<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-800 leading-tight italic">Tambah Jurusan Baru</h2>
    </x-slot>
            ...
            <form action="{{ route('admin.jurusan.store') }}" method="POST">
                ...
                <div class="bg-white shadow-2xl rounded-[2rem] overflow-hidden border border-gray-100 p-10">
                    ...
                    <div class="flex justify-end gap-4 border-t border-gray-100 pt-6 mt-8">
                        ...
                        <button type="submit" class="px-10 py-3 bg-orange-600 text-white font-black rounded-xl shadow-lg hover:bg-orange-700 uppercase tracking-widest text-xs transform hover:-translate-y-0.5 transition-all">SIMPAN JURUSAN</button>
                    </div>
                </div>
            </form>
        </div>
