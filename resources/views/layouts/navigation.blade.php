<aside 
    ...
    <nav class="flex-1 mt-6 px-3 space-y-2 overflow-y-auto">
        ...
        <div class="pt-4 pb-2">
            ...
            <a href="#" class="flex items-center p-3 rounded-xl hover:bg-orange-500 transition-colors">
                <svg class="w-6 h-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
                </svg>
                <span :class="sidebarOpen ? 'opacity-100 ml-4' : 'opacity-0 w-0'" class="font-medium transition-all duration-300 overflow-hidden whitespace-nowrap">Perangkat IoT</span>
            </a>
        </div>
        @endif
